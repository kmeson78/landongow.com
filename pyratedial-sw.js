...
const CACHE_PREFIX = "pyrate-dial-recovery-";
const CACHE_NAME = CACHE_PREFIX + BUILD;
const BASE = new URL('./', self.location.href);
const PAGE_URL = new URL("pyratedial.html", BASE);
const ASSETS = [
  "pyratedial.html",
  "pyratedial-recovery.css?v=20260916-live1",
  "pyratedial-recovery.js?v=20260916-live1",
